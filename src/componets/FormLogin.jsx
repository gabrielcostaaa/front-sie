...
function FormLogin() {
  ...
  const onSubmit = (data) => {
    console.log(data); // Faça algo com os dados submetidos
  };
    ...
    return (
        <div className=''>
            ...
            <div className='mt-8'>
                ...
                <button type="button" className='active:scale-[0.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all text-white text-base bg-blue-600 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'>Entrar</button>
                </div>
            </div>
        </div>
    )
